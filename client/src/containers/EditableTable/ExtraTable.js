					...
					<tr>
						...
						<td className='half-td'>
							<input
								...
								autoComplete='off'
								onChange={(e) => this.handleChange(e)}
								value={this.props.data.getIn([ 'table_extradata', 5, 0 ])}
							/>
						</td>
						<td className='half-td'>
							<input
								...
								autoComplete='off'
								onChange={(e) => this.handleChange(e)}
								value={this.props.data.getIn([ 'table_extradata', 5, 1 ])}
							/>
						</td>
					</tr>
					<tr>
						<td>R22:</td>
						<td className='half-td'>{this.props.data.getIn([ 'table_extradata', 6, 0 ])}</td>
					</tr>
					<tr>
						<td>S22:</td>
						<td className='half-td'>{this.props.data.getIn([ 'table_extradata', 6, 1 ])}</td>
					</tr>
					<tr>
						<td style={{ verticalAlign: 'top' }}>Basic</td>
						<td colSpan='2'>
							<table style={{ backgroundColor: '#f1f1f1' }}>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 0 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 1 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 2 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 3 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 4 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 5 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 6 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 7 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 8 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 9 ])}</td>
								</tr>
								<tr>
									<td>{this.props.data.getIn([ 'table_extradata', 7, 10 ])}</td>
								</tr>
							</table>
						</td>
					</tr>
