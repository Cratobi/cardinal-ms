	...
	return (
		<Fragment>
			<div className="auth-header">
				...
				<div className="txt-title">Flaxen Group Ltd</div>
				<div className="txt-small">Cardinal System</div>
			</div>
			<CSSTransition in={props.alert !== '' ? true : false} timeout={250} classNames="outside" unmountOnExit>
			...
			<form className="auth-form" method="post" onSubmit={props.handleSubmit}>
				...
				<div className="btn-container">
					<button disabled={props.form.username ? false : true} onClick={props.handleSubmitEmail}>
						HELP?
					</button>
					<button
						onClick={props.handleSubmitForm}
